...
enum {
    ...
    TERRAIN_NOT_CLEAR = (0xd77f | TERRAIN_HIGHWAY) & ~TERRAIN_RUBBLE,
    TERRAIN_NOT_CLEAR_EXCEPT_ROAD = (0xd73f | TERRAIN_HIGHWAY) & ~TERRAIN_RUBBLE,
    TERRAIN_CLEARABLE = (0xd17f | TERRAIN_HIGHWAY) | TERRAIN_RUBBLE,
    ...
    TERRAIN_ALL_EXCEPT_RUBBLE = (0xffff | TERRAIN_HIGHWAY) & ~TERRAIN_RUBBLE,
